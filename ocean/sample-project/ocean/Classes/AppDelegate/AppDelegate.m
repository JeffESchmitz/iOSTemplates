...
-(void)customizeiPadTheme
{
    ...
    if(![Utils isVersion6AndBelow])
        navBarImage = [UIImage tallImageNamed:@"ipad-menubar-right-7.png"];
    ...
    if(![Utils isVersion6AndBelow])
        barItemImage = [[UIImage tallImageNamed:@"menubar-button-7.png"] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 5, 0, 5)];
