...
+ (void)initialize
{
    ...
    {
        background = [UIImage tallImageNamed:kAlertViewBackground];
        //background = [[background resizableImageWithCapInsets:UIEdgeInsetsMake(14, 14, 14, 14)] retain];
        background = [[background stretchableImageWithLeftCapWidth:10 topCapHeight:10] retain];
